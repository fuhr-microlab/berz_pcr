...
def parse_args():
    ...
    ap.add_argument("--min-len", type=int, default=50, help="Minimum allowed product length (bp).")
    ap.add_argument("--max-len", type=int, default=8000, help="Maximum allowed product length (bp).")
